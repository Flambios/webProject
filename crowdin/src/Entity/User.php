...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Lang", inversedBy="users")
     */
    private $langs;
    ...
    public function addSource(Project $source): self
    {
    ...
    public function removeSource(Project $source): self
    {
        if ($this->sources->contains($source)) {
